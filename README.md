...
- **[Download dist.zip](https://raw.githubusercontent.com/rushi-gulum/prompt-compiler/main/dist.zip)**

### Install Steps

1. Download `dist.zip` using the link above.
...
6. Select the extracted folder that contains `manifest.json`:
   - usually the extracted **dist** folder
   - or the extracted root folder if `manifest.json` is directly inside it
...
- Validate built manifest before sharing/distributing.
